...
# Memory: enet_nios_mem
MEM_0 := system_init_
$(MEM_0)_NAME := enet_nios_mem
...
$(MEM_0)_HIERARCHICAL_PATH := enet_nios_mem
$(MEM_0)_WIDTH := 32
...
.PHONY: enet_nios_mem
enet_nios_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
