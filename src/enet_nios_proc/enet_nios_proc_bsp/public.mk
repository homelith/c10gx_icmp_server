...
# CPU Name 
# setting CPU_NAME is enet_nios_proc
CPU_NAME = enet_nios_proc
...
# setting hal.stderr is enet_nios_jtaguart
ELF_PATCH_FLAG  += --stderr_dev enet_nios_jtaguart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is enet_nios_jtaguart
ELF_PATCH_FLAG  += --stdin_dev enet_nios_jtaguart
...
# setting hal.stdout is enet_nios_jtaguart
ELF_PATCH_FLAG  += --stdout_dev enet_nios_jtaguart
